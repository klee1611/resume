...
\item Designed a Backend-For-Frontend (BFF) architecture utilizing decoupled asynchronous worker queues (Celery, AWS SQS) for CPU-bound 3D asset manipulation, ensuring fault-tolerant, non-blocking API Gateways
...
\begin{resumeitems}
\item Engineered full-stack mail flow control features in C++ (Postfix/Dovecot), implementing GDPR data privacy mechanisms and resolving critical system-level memory leaks and race conditions.
\end{resumeitems}
